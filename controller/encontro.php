...
$msg = clear($_POST['msg']);
$assunto = "Marcar Encontro Com Pastor";
...
//Server settings
	...
	$mail->Body = "Olá, tudo bem sou " . $nome . "<br> <br> <br> " . "Sou residente do bairro $city em $pais e tenho $idade anos
	<br> <br> Meu contacto: $contato <br> <br> $msg <br> <br> TAF obrigado por contactar. ";
