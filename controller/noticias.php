...
if (isset($_POST)) {
	...
	if (in_array($ext, $format)) {
		$dir = "../galeria/noticias/"; // pasta que vai ter os upload
	...
	$sql = "INSERT INTO noticias (id, titulo, subtitulo, texto, data, autor, foto) VALUES (NULL, '$titulo', '$subtitulo', '$noticia', NOW(), '$autor', '$newName')";
	if (mysqli_query($connect, $sql)) {
		header('Location: ../administrador/news.php?cadastro = sucess');
		exit();
	}
}
