...
//Server settings
	...
	$mail->Body = "Olá, tudo bem sou " . $nome . "<br> <br> <br> " . "Sou residente do bairro $city em $pais e tenho $idade anos do sexo $sexo
	<br><br><br> $msg <br> <br> TAF obrigado por contactar. ";
	$mail->send();
