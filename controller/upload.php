...
if (isset($_POST)) {
	...
	if (in_array($ext, $format)) {
		$dir = "../galeria/slides/"; // pasta que vai ter os upload
	...
	$sql = "INSERT INTO upload_slides (id, arquivo, data, descricao, status) VALUES (NULL, '$newName', NOW(), '$desc', 0)";
	if (mysqli_query($connect, $sql)) {
		header('Location: ../administrador/upload.php?upload = sucess');
		exit();
	}
}
