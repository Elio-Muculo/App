...
if (isset($_POST)) {
	...
	if (in_array($ext, $format)) {
		$dir = "../galeria/dep-jovens/"; // pasta que vai ter os upload
	...
	$sql = "INSERT INTO departamentospower (id, arquivo, data, descricao) VALUES (NULL, '$newName', NOW(), '$desc')";
	if (mysqli_query($connect, $sql)) {
		header('Location: ../administrador/admnistrar-departamentos.php?upload = sucess');
		exit();
	}
}
