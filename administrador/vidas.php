        ...
        <div class="row">
            <div class="col-lg-12 ">
                <div class="alert alert-info">
                    <strong>Bem - vindo! cadastre novas historias de vida transformadas e deixe seus seguidores actualizados</strong>
                </div>
            </div>
        </div>
        <form action="../controller/vidastransform.php" method="post" accept-charset="utf-8" enctype="multipart/form-data">
            <div class="form-row">
