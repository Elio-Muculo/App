			...
			<div class="row d-flex flex-md-nowrap flex-wrap ">
				<div class="col-md-9 bg-white shadow-sm">
					...
					<div class="mt-5 ml-4">
						...
						<h5 class="pt-2">QUEM SOMOS</h5>
					</div>
					<div class="mt-2 ml-5">
						<h5 class="pt-2">
						<p>A Igreja Tabernáculo Aliança da Fé é uma instituição religiosa sem fins lucrativas que foi fundada por Sérgio Licova </p>
						<p>e com sua esposa Ester Samuel Licova ambus de nacionalidade moçambicana, na Cidade da Beira, </p>
						<p>província de Sofala em Moçambique. </p>
						<p>Nos finais de Outubro de 2005 depois de Deus ter falado com Apóstolo Sérgio Licova dizendo</p>
						<p>´´começa uma obra e Eu te sustentarei`` em obediência a Deus fundaram essa igreja.</p>
						<p>Actualmente está em quatro (4) províncias de Moçambique </p>
						<p>e com a permissão de Deus espera-se que esteja em todo país e em outros cantos do Mundo.</p>
						</h5>
					</div>
				</div>
