            ...
            <div class="row d-flex flex-md-nowrap flex-wrap">
                <div class="col-md-9 bg-white shadow-sm">
                    ...
                    <div class="mt-5 ml-4 mb-4">
                        ...
                        <h5 class="pt-2">JOVEM COM FORÇA</h5>
                    </div>
                    <div>
                        <div class="col-md-12">
                            <section class="painel mais-vendidos">
                                <div class="row">
                                    <?php
$dados = mysqli_query($connect, "SELECT *   FROM    departamentospower ORDER BY id DESC LIMIT 9");
                                        ...
                                        <div class="painel">
                                            <li class="bg-dark">
                                                <a href="produto.php?id=<?=$produto['id']?>">
                                                    <figure>
                                                        <img src="../galeria/dep-jovens/<?=$produto['arquivo']?>" alt="<?php echo utf8_encode($produto['nome']); ?>" class="content">
