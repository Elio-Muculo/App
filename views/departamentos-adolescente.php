                    ...
                    <div>
                        <div class="col-md-12">
                            <section class="painel mais-vendidos">
                                <div class="row">
                                    <?php
$dados = mysqli_query($connect, "SELECT *   FROM    departamentosadol ORDER BY id DESC LIMIT 9");
                                        ...
                                        <div class="painel">
                                            <li class="bg-dark">
                                                <a href="produto.php?id=<?=$produto['id']?>">
                                                    <figure>
                                                        <img src="../galeria/dep-adol/<?=$produto['arquivo']?>" alt="<?php echo utf8_encode($produto['nome']); ?>" class="content">
